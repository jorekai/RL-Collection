...
class NN:
    ...
    Notice:
        You can average either the gradients (during training),
         the weights (at the end -- see Polyak averaging for instance),
          or the final predictions (at inference time)
    """
